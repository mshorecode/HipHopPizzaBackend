...
public class HipHopPizzaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            new Order { Id = 1, CustomerName = "Johnny Saniat", CustomerEmail = "johnnyyourmomcalled@gmail.com", CustomerPhone = 615 - 555 - 5512, OrderTypeId = 1, Subtotal = 10, Tip = 10, Total = 20, OrderDate = new DateTime(), IsComplete = true },
